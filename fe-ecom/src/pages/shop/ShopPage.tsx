...
const ShopPage: React.FC = () => {
  return (
    <>
      ...
      <div className="mt-10 mb-4 flex justify-center rounded-lg bg-[#FAF4F4] p-4 shadow">
        <div className="container flex flex-wrap items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              type="number"
              defaultValue={16}
              className="w-16 rounded-lg border border-gray-300 bg-white px-2 py-1 text-lg shadow-sm"
            />
            <span className="ml-2 text-lg font-semibold">Sort by:</span>
            <select className="rounded-lg border border-gray-300 bg-white px-3 py-2 text-lg shadow-sm">
